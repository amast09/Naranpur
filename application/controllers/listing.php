...
class Listing extends CI_Controller{
	...
	function view_all_listings($resource_id = -1, $offset = 0){
		...
		$data['js_files'][0] = base_url('resources/read_listings_view/js/createListing.js');
	...
	function view_listing($listing_id){
		...
		if($listing->num_rows() != 1)	echo "Not a valid listing";
			...
			$data['css_files'][0] = base_url('resources/read_listing_view/css/read-listing-view.css');
	...
	function load_create_bid($listing_id){
		...
		if($listing_query->num_rows() != 1 || $listing_query->row()->family_name == $family_name){
			...
			$data['css_files'][0] = base_url('resources/create_bid_view/css/create-bid-view.css');
			$data['js_files'][0] = base_url('resources/create_bid_view/js/createBid.js');
