...
$(function() {
	...
	rsr.image('<?=base_url("/resources/lmu_view/img/bg$lmu_type.jpg")?>',0,0,1200,550);

	var hut = rsr.image("<?=base_url("/resources/lmu_view/img/hut.png")?>", 270, 300, 170, 100);
	var barn = rsr.image("<?=base_url("/resources/lmu_view/img/barn.png")?>", 860, 300, 300, 210);
	var well = rsr.image("<?=base_url("/resources/lmu_view/img/well.png")?>", 500, 350, 100, 65);
	var farmer = rsr.image("<?=base_url("/resources/lmu_view/img/farmer.png")?>", 600, 380, 167, 170);
	...
	for(var i = 0; i < 10; i++){
		for(var j = 0; j < 10; j++){
			var image = "<?=base_url("/resources/lmu_view/img")?>" + "/" + images[z];
			field.push(
